    ...
    <section className="bg-white py-12 w-full border-b border-gray-100">
      <div className="w-full px-4 md:px-10">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <Link to="/shop" className="text-slate-900 font-bold text-[10px] md:text-xs uppercase tracking-widest flex items-center gap-2 hover:text-cyan-600 transition-colors group">
