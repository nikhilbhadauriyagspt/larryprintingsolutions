...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are Larry Printing Solutions
 
  ("Company," "we," "us," "our"), a company registered in Minnesota, United States at 2453 Hennepin Ave, Minneapolis, MN 55405, USA.
      </p>
      <p>
        We operate the website <a href="http://Larry Printing Solutions.shop/">http://Larry Printing Solutions.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        Larry Printing Solutions
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://Larry Printing Solutions.shop/return-policy">http://Larry Printing Solutions.shop/return-policy</a>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://Larry Printing Solutions.shop/privacy-policy">http://Larry Printing Solutions.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
